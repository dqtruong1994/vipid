...
import { LayoutAdmin, Loading, NotFound } from '../components';
...
const ForgotPassword = lazy(
    () => import('../feature/auth/page/forgot-password')
);
const ResetPassword = lazy(() => import('../feature/auth/page/reset-password'));
const ChangePassword = lazy(
    () => import('../feature/auth/page/change-password')
);
...
const EditAvatar = lazy(() => import('../feature/profile/page/edit-avatar'));
...
const GroupDetail = lazy(() => import('../feature/profile/page/group-detail'));
// setting theme
